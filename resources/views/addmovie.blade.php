...
<body>
    ...
    <form style="padding-left: 10px; padding-right: 10px;" action="/movie/save"
    ...
    {{ csrf_field() }}
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="txt_deskripsi"   name="deskripsi" 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="txt_sutradara" name="sutradara"
